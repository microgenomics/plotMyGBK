...
* If you want to classify your genes by functions (-C flag), download the zip from [here](https://www.dropbox.com/s/n6ycyhrtlz3ixeb/data.zip?dl=0), and unzip. This package have all neccesary files to classify your genes using the COG Assignments.
